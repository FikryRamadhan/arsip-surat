...
<body>    
    <div class="header">
        <center>
            <div class="intro">
                <p class="intro_1">Dinas Pertanian Kab. Kuningan</p>
                <p class="intro_2">Cigadung, Kec. Cigugur, Kabupaten Kuningan, Jawa Barat 45552</p>
            </div>
        </center>
    </div>
    ...
    <div class="content">
        <div class="day">
            <p class="date">Kuningan, {{ date('d F Y') }}</p>
        </div>
        <div class="pembuka">
            <ul>
    ...
    <div class="footer">
        <p class=>Kuningan, {{ date('d F Y') }}</p>
        <br><br><br>
        <p class="ttd">Dinas Pertanian</p>
    </div>
